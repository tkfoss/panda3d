"""Regression tests for object-lifetime / use-after-free fixes.

Each test here exercises a path that previously dereferenced freed memory and
crashed.  They must run to completion without segfaulting.
"""
