...
#ifdef BUILDING_PANDARMUI
  #define EXPCL_PANDARMUI EXPORT_CLASS
  #define EXPTP_PANDARMUI EXPORT_TEMPL
#else
  #define EXPCL_PANDARMUI IMPORT_CLASS
  #define EXPTP_PANDARMUI IMPORT_TEMPL
#endif
