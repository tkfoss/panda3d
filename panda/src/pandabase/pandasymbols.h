...
#ifdef BUILDING_PANDARMLUI
  #define EXPCL_PANDARMLUI EXPORT_CLASS
  #define EXPTP_PANDARMLUI EXPORT_TEMPL
#else
  #define EXPCL_PANDARMLUI IMPORT_CLASS
  #define EXPTP_PANDARMLUI IMPORT_TEMPL
#endif
